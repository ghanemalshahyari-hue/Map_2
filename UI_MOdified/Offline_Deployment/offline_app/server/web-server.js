...
const server = http.createServer((req, res) => {
    ...
    if (pathname === '/api/scenario/import' && req.method === 'POST') {
        ...
        readJsonBody(req, { maxBytes: 25_000_000 }).then((body) => {
            ...
            // FAST-INT-2: stamp external-pipeline provenance. Additive metadata
            // only — does NOT alter the porter's unit/coord/phase output (the
            // porter remains the single source of import logic). Lets RMOOZ show
            // "generated by WarGamingGEN" and avoid treating it as authored.
            ...
            sendJson(res, 200, {
                ...
                generated_from_external_pipeline: true,
...
server.listen(PORT, '0.0.0.0', () => {
    ...
    console.log('  Note: if localhost is served by another process on this machine, prefer 127.0.0.1.');
});
