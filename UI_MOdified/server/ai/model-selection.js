...
let _loaded       = false;
let _selected     = null;            // the runtime-file selection (null = none/invalid)
...
function setSelectedModel(model) {
    ...
    try {
        ...
        return { ok: true, selected_model: m, persisted: true, file: file };
    } catch (e) {
        ...
        return { ok: true, selected_model: m, persisted: false, file: file,
...
// ── test hooks ───────────────────────────────────────────────────────────────
function _setSelectionFileForTest(p) { _fileOverride = p || null; _loaded = false; _selected = null; }
function _reloadForTest() { _loaded = false; _selected = null; load(); }
